...
KernelLayer = CustomKernelLayer(1, 'kernel_layer', kernel);
...
Abs1Layer       = CustomAbsoluteLayer(2, 'absolute_layer_1');
Angle1Layer     = CustomAngleLayer(2, 'angle_layer_1');
...
lgraph = connectLayers(lgraph, 'nonlinear_layer', 'real_imag_layer/in1');
lgraph = connectLayers(lgraph, 'angle_layer_1', 'real_imag_layer/in2');

lgraph = connectLayers(lgraph, 'real_imag_layer/out1', 'real_prop_2_conv2d_layer_A');
lgraph = connectLayers(lgraph, 'real_imag_layer/out1', 'imag_prop_2_conv2d_layer_B');
lgraph = connectLayers(lgraph, 'real_imag_layer/out2', 'real_prop_2_conv2d_layer_C');
lgraph = connectLayers(lgraph, 'real_imag_layer/out2', 'imag_prop_2_conv2d_layer_D');
